                                            ...
                                            ockam_writer_t**    pp_writer)
{
  ...
  ockam_error_t error     = ockam_transport_socket_tcp_init(p_transport, &tcp_attributes);
...
ockam_error_t channel_responder(ockam_vault_t* vault, ockam_memory_t* p_memory, ockam_ip_address_t* ip_address)
{
  ...
  ockam_error_t error = establish_responder_transport(&transport, p_memory, ip_address, &p_transport_reader, &p_transport_writer);
  if (ockam_error_has_error(&error)) goto exit;
