...
#define OCKAM_VAULT_ERROR_INIT_FAIL                  (OCKAM_ERROR_INTERFACE_VAULT | 1u)
#define OCKAM_VAULT_ERROR_RANDOM_FAIL                (OCKAM_ERROR_INTERFACE_VAULT | 2u)
#define OCKAM_VAULT_ERROR_SHA256_FAIL                (OCKAM_ERROR_INTERFACE_VAULT | 3u)
#define OCKAM_VAULT_ERROR_SECRET_GENERATE_FAIL       (OCKAM_ERROR_INTERFACE_VAULT | 4u)
#define OCKAM_VAULT_ERROR_SECRET_IMPORT_FAIL         (OCKAM_ERROR_INTERFACE_VAULT | 5u)
#define OCKAM_VAULT_ERROR_SECRET_EXPORT_FAIL         (OCKAM_ERROR_INTERFACE_VAULT | 6u)
#define OCKAM_VAULT_ERROR_SECRET_ATTRIBUTES_GET_FAIL (OCKAM_ERROR_INTERFACE_VAULT | 7u)
#define OCKAM_VAULT_ERROR_PUBLIC_KEY_FAIL            (OCKAM_ERROR_INTERFACE_VAULT | 8u)
#define OCKAM_VAULT_ERROR_ECDH_FAIL                  (OCKAM_ERROR_INTERFACE_VAULT | 9u)
#define OCKAM_VAULT_ERROR_HKDF_SHA256_FAIL           (OCKAM_ERROR_INTERFACE_VAULT | 10u)
#define OCKAM_VAULT_ERROR_AEAD_AES_GCM_ENCRYPT_FAIL  (OCKAM_ERROR_INTERFACE_VAULT | 11u)
#define OCKAM_VAULT_ERROR_AEAD_AES_GCM_DECRYPT_FAIL  (OCKAM_ERROR_INTERFACE_VAULT | 12u)
#define OCKAM_VAULT_ERROR_AEAD_AES_GCM_FAIL          (OCKAM_ERROR_INTERFACE_VAULT | 13u)
#define OCKAM_VAULT_ERROR_INVALID_PARAM              (OCKAM_ERROR_INTERFACE_VAULT | 20u)
#define OCKAM_VAULT_ERROR_INVALID_ATTRIBUTES         (OCKAM_ERROR_INTERFACE_VAULT | 21u)
#define OCKAM_VAULT_ERROR_INVALID_CONTEXT            (OCKAM_ERROR_INTERFACE_VAULT | 22u)
#define OCKAM_VAULT_ERROR_INVALID_BUFFER             (OCKAM_ERROR_INTERFACE_VAULT | 23u)
#define OCKAM_VAULT_ERROR_INVALID_SIZE               (OCKAM_ERROR_INTERFACE_VAULT | 24u)
#define OCKAM_VAULT_ERROR_INVALID_REGENERATE         (OCKAM_ERROR_INTERFACE_VAULT | 25u)
#define OCKAM_VAULT_ERROR_INVALID_SECRET             (OCKAM_ERROR_INTERFACE_VAULT | 26u)
#define OCKAM_VAULT_ERROR_INVALID_SECRET_ATTRIBUTES  (OCKAM_ERROR_INTERFACE_VAULT | 27u)
#define OCKAM_VAULT_ERROR_INVALID_SECRET_TYPE        (OCKAM_ERROR_INTERFACE_VAULT | 28u)
...
#define OCKAM_VAULT_ERROR_MEMORY_REQUIRED            (OCKAM_ERROR_INTERFACE_VAULT | 32u)
#define OCKAM_VAULT_ERROR_SECRET_SIZE_MISMATCH       (OCKAM_ERROR_INTERFACE_VAULT | 33u)
